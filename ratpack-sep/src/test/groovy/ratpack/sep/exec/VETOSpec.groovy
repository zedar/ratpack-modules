...
class VETOSpec extends Specification {
  ...
  def "verify combined with operate defined with factory methods"() {
    ...
    ExecResult<ActionResults<ResponseData>> result = harness.yield { ec ->
      verify.apply(ec, registry, Action.<RequestData,RequestData>of("verify", null) { ec2, data -> ec2.promise { f ->
      ...
      .flatMap { actionResults ->
        ...
        operate.apply(ec, registry, Action.<RequestData,ResponseData>of("operate", null) { ec2, data -> ec2.promise { f->
